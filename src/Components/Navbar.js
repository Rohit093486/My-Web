...
class Navbar extends Component{    
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" style={{backgroundColor:"#F0F3F4" ,border:"ThreeDShadow 2px solid",zIndex:50 }}>
            <Link to="/" style={ {textDecoration:"none"}}><h4 style={{ textShadow: '1px 1px 1px', fontFamily: "cursive", color: "#F39618" }}>My Cake</h4></Link>
            {this.props.islogged &&<p style={{ marginLeft: "3em", fontFamily: "cursive", fontSize: "1.2em" }}>{`Welcome  ${localStorage.name}`}</p>}
